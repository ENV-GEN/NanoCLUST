...
if(params.multiqc){
 ...
 process read_correction {
     ...
     canu -correct -p corrected_reads -nanopore-raw subset.fastq genomeSize=${params.avg_amplicon_size} stopOnLowCoverage=1 minInputCoverage=2 minReadLength=${params.min_read_length} minOverlapLength=200
